const messages = {
    ...
    pdfAddSuccess : ["Pdf Added Successfully"],
    ...
    msgCategoryDeleteSuccess : ["Category Deleted Successfully"],

    msgSubscriptionAddedSuccess : ["Subscription Added Successfully"],

    msgSubscriptionUpdateSuccess : ["Subscription Update Successfully"],

    msgSubscriptionDeleteSuccess : ["Subscription deleted Successfully"],
