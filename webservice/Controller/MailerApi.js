                ...
                <table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="logo" style="padding:25px 0 30px 0; text-align:center; border-bottom:1px solid #E1E1E1">
                            <img src="https://app.the-butler-collection.com/butler_hospitality/server/webservice/logo/logo.png" alt="" width="20%" >
                            <h2>${title}</h2>
                        </td>
                    </tr>
                    <tr><td></td></tr>  
                    ...
                    <tr>                
                        <td  style="background: #94CF9E;  padding-bottom:60px;">
